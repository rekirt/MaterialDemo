...
public class RecyclerViewCircleActivity extends AppCompatActivity {
    ...
    class Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MyViewHolder(LayoutInflater.from(RecyclerViewCircleActivity.this).inflate(R.layout.my_image,parent,false));
        }
